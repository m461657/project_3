...
*Random Forest*
```{r}
artists_train = droplevels(artists_train)
artists_test = droplevels(artists_test)

# fit a random forest
artists_rf = rand_forest() %>% 
...
# create a new column called pred_track_artist --> this gives the predicted track_artist based on our random forest
# calculate the accuracy
artists_test %>% 
  mutate(pred_track_artist = rf_pred$.pred_class) %>% 
  accuracy(truth = track_artist, estimate = pred_track_artist)
