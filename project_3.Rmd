...
Finally, we explored the average `acousticness` for each of our 14 artists. Graphing it the same way as the others before, we find that Vampire Weekend again comes out on top, but this time for acoustiness. This graph also shows deep variations between the artists based on the acousticness of their tracks.
```{r}
favorite_artists %>% 
  group_by(track_artist) %>% 
